...
\vspace{1em}
\begin{itemize}
	\item \textbf{Art:} \cvtag{drawing} \cvtag{painting}  \cvtag{photography}
    \item \textbf{Music:} \cvtag{ukulele} \cvtag{piano}
    \item \textbf{Sports:} \cvtag{running} \cvtag{cycling}\cvtag{rock climbing}
\end{itemize}
}